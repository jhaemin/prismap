...
fs.writeFileSync(prismaSchemaPath, modelProcessedSchema, {
  encoding: 'utf8',
})

formatSchema({ schemaPath: prismaSchemaPath }).then((formatted) => {
  fs.writeFileSync(prismaSchemaPath, formatted, {
    encoding: 'utf8',
  })
})
